...
export CLOUD_IMAGE_NAME=us-docker.pkg.dev/your-project-id/your-repository-name/maxtext-custom
...
If you provide just a simple image name, the script will default to uploading to GCR under your current active gcloud project (`gcr.io/your-project-id/your-image-name:latest`).

```bash
# 1. Define a simple image name
export CLOUD_IMAGE_NAME=maxtext-custom
